...
alias rdrop="psql -d postgres -c \"SELECT pg_terminate_backend(pid) FROM pg_stat_activity WHERE datname != 'postgres';\" && bundle exec rails db:drop"
...
alias rproddb='RAILS_ENV=production DISABLE_DATABASE_ENVIRONMENT_CHECK=1 bundle exec rails db:reset'
