...
export CPPFLAGS='-I/opt/homebrew/opt/llvm/include -I/opt/homebrew/opt/postgresql@17/include'
...
export LDFLAGS='-L/opt/homebrew/opt/llvm/lib/c++ -L/opt/homebrew/opt/postgresql@17/lib'
...
export PATH=$ICLOUD/coding/bin:$HOME/.asdf/shims:$HOME/.cargo/bin:/opt/homebrew/opt/gnu-sed/libexec/gnubin:/opt/homebrew/opt/llvm/bin:/opt/homebrew/opt/postgresql@17/bin:$PATH
